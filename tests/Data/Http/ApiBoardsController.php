...
use Whoa\Tests\Flute\Data\Api\BoardsApi as Api;
...
use Whoa\Tests\Flute\Data\Validation\JsonQueries\ReadBoardsQueryRules;
...
class ApiBoardsController extends ApiBaseController
{
    ...
    /** @inheritdoc */
    public const ON_INDEX_QUERY_VALIDATION_RULES_CLASS = ReadBoardsQueryRules::class;

    /** @inheritdoc */
    public const ON_READ_QUERY_VALIDATION_RULES_CLASS = ReadBoardsQueryRules::class;

    /** @inheritdoc */
    public const ON_CREATE_DATA_VALIDATION_RULES_CLASS = CreateBoardRules::class;

    /** @inheritdoc */
    public const ON_UPDATE_DATA_VALIDATION_RULES_CLASS = UpdateBoardRules::class;
